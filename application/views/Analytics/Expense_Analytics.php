...
<body>
        ...
        <div class="mt-20 px-4">
            <div class="grid grid-cols-1 gap-8 px-20 py-2">
                <div class="rounded-lg shadow-md px-20 bb">
                    <h2 class="text-2xl text-center font-bold mb-4 text-white">Daily Expense</h2>
                ...
                <div class="bg-white rounded-lg shadow-md px-20 bb">
                    <h2 class="text-2xl text-center font-bold mb-4 text-white">Monthly Expense</h2>
    ...
    <script>
        <?php include '/assets/expense_analytics'; ?>
    </script>
</body>
